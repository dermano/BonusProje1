...
namespace BonusProje1.DataSet1TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("OGRCİNSİYET", "OGRCINSIYET");
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT        TBLOGRENCI.OGRID, TBLOGRENCI.OGRAD, TBLOGRENCI.OGRSOYAD, TBLOGRENCI" +
                ".OGRCİNSİYET, TBLKULUPLER.KULUPAD\r\nFROM            TBLOGRENCI INNER JOIN\r\n      " +
                "                   TBLKULUPLER ON TBLOGRENCI.OGRKULUP = TBLKULUPLER.KULUPID";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT        TBLOGRENCI.OGRID, TBLOGRENCI.OGRAD, TBLOGRENCI.OGRSOYAD, TBLOGRENCI.OGRCİNSİYET, TBLKULUPLER.KULUPAD
FROM            TBLOGRENCI INNER JOIN
                         TBLKULUPLER ON TBLOGRENCI.OGRKULUP = TBLKULUPLER.KULUPID
WHERE        (TBLOGRENCI.OGRAD = @OGRAD)";
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@OGRCİNSİYET", global::System.Data.SqlDbType.Variant, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "OGRCİNSİYET", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "DELETE FROM TBLOGRENCI\r\nWHERE        (OGRID = @OGRID)";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[4].CommandText = "UPDATE TBLOGRENCI \nSET OGRAD = @OGRAD, OGRSOYAD = @OGRSOYAD, OGRKULUP = @OGRKULUP" +
                ", OGRCİNSİYET = @OGRCİNSİYET \nWHERE OGRID = @OGRID";
            ...
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@OGRCİNSİYET", global::System.Data.SqlDbType.Variant, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "OGRCİNSİYET", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual object OgrenciEkle(string OGRAD, string OGRSOYAD, global::System.Nullable<byte> OGRKULUP, object OGRCİNSİYET) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[2];
            if ((OGRAD == null)) {
                command.Parameters[0].Value = global::System.DBNull.Value;
            }
            ...
            if ((OGRCİNSİYET == null)) {
                ...
                command.Parameters[3].Value = ((object)(OGRCİNSİYET));
            }
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int OgrGuncelle(string OGRAD, string OGRSOYAD, global::System.Nullable<byte> OGRKULUP, object OGRCİNSİYET, int OGRID) {
